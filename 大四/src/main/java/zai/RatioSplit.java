...
public class RatioSplit {
    ...
    public static final String OUTPUT_EXCEL = "C:\\Users\\Administrator\\Desktop\\zai\\with_split.xlsx";
...
//            BigDecimal tem = new BigDecimal(electricity.getTemperature());

            BigDecimal level = light.multiply(BigDecimal.valueOf(1));
            BigDecimal value = electricity.getLight().equals("0") ? BigDecimal.ZERO : power.divide(light, 8, BigDecimal.ROUND_HALF_UP);

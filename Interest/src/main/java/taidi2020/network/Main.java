 ...
 */
public class Main {
	public static int neuronLength=3;//隐含层数量
	public static double learnSpeed=0.06;//学习速度
	public static double activationTimes=1000;//迭代次数
	public static double resultThreshold[]= null;//结果阈值
	public static double resultRate=0;//成功率

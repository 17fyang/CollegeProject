...
public class CLSDeal {
	...
	public String[] RWS(String[] group){
		...
		TestResult testResult = cls.fitAll(group);	//计算适应度数组
		int rank[]=testResult.rank;
		System.out.println(testResult.coverage);
		int oldNumber=ModelConfig.groupNumber*10/11;

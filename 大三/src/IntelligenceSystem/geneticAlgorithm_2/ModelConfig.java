...
public class ModelConfig {
	...
	public static final int runTimes = 500000;	//迭代次数
	public static final int accuracy = 24;	//精确度，选择精确到小数点后几位
	public static final double correctFitness=186.730909;//正确的适应值
	public static final double fitnessAccuracy=0.0001;//适应度识别精度
